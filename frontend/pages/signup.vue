<template>
  <div>
    <b-form @submit.prevent="submit" novalidate>
      ...
      <b-form-group label="Repeat Password" :invalid-feedback="errors.first('password_rpt')" :state="!errors.has('password_rpt')">
        <b-form-input type="password" data-vv-value-path="innerValue" name="password_rpt" v-validate="'confirmed:target=password'"></b-form-input>
      </b-form-group>
